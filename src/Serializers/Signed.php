...
use Artgames\SerializableClosure\Exceptions\MissingSecretKeyException;
...
class Signed implements Serializable
{
     ...
     *
     * @var \Artgames\SerializableClosure\Contracts\Signer|null
     */
    ...
    public function __unserialize($signature)
    {
        ...
        /** @var \Artgames\SerializableClosure\Contracts\Serializable $serializable */
